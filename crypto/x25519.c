...
/*
 * Curve25519 Montgomery ladder, in the style of TweetNaCl (public
 * domain): field elements are 16 signed 64-bit limbs of 16 bits each,
 * and every secret-dependent choice is a constant-time conditional swap.
 * Slow-but-simple; a scalar multiplication is a few million
 * instructions, which is nothing next to a network round trip.
 */
